...
final class ArtisanServiceFixtures extends Fixture implements \Doctrine\Common\DataFixtures\DependentFixtureInterface
{
    private const ENTITY_CLASS = ArtisanService::class;
    private const RECORDS_PER_ENTITY = 1000;
    public function getDependencies(): array
    {
        return [ArtisanProfileFixtures::class, CategoryFixtures::class];
    }
