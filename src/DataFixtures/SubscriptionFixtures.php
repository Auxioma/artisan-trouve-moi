...
final class SubscriptionFixtures extends Fixture implements \Doctrine\Common\DataFixtures\DependentFixtureInterface
{
    private const ENTITY_CLASS = Subscription::class;
    private const RECORDS_PER_ENTITY = 1000;
    public function getDependencies(): array
    {
        return [ArtisanProfileFixtures::class, SubscriptionPlanFixtures::class];
    }
