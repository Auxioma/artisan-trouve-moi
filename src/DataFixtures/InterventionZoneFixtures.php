...
final class InterventionZoneFixtures extends Fixture implements \Doctrine\Common\DataFixtures\DependentFixtureInterface
{
    private const ENTITY_CLASS = InterventionZone::class;
