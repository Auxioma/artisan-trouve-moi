...
final class QuoteFixtures extends Fixture implements \Doctrine\Common\DataFixtures\DependentFixtureInterface
{
    private const ENTITY_CLASS = Quote::class;
    private const RECORDS_PER_ENTITY = 1000;
    public function getDependencies(): array
    {
        return [ServiceRequestFixtures::class, ArtisanProfileFixtures::class];
    }
