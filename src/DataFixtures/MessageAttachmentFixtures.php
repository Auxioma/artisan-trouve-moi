...
final class MessageAttachmentFixtures extends Fixture implements \Doctrine\Common\DataFixtures\DependentFixtureInterface
{
    private const ENTITY_CLASS = MessageAttachment::class;
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        for ($index = 1; $index <= $this->recordCount(); ++$index) {
            ...
            $directory = $this->kernel->getProjectDir().DIRECTORY_SEPARATOR.'var'.DIRECTORY_SEPARATOR.'fixture-uploads'.DIRECTORY_SEPARATOR.'MessageAttachment';
